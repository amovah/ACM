...
# one time for each day they'll work that task. As shifts are planned well in advance,
# the lists for each task will contain up to 99 integers.
# When a minion is scheduled for the same task too many times,
# they'll complain about it until they're taken off the task completely.
# Some tasks are worse than others,
...
# have been assigned a task too many times before they even get a chance to start complaining.
#
...
print(answer([1, 2, 2, 3, 3, 3, 4, 5, 5], 2))
